export default function FloatingWhatsApp() {
  return (
    <a
      ...
      className="fixed bottom-20 md:bottom-6 right-4 md:right-6 z-50 w-14 h-14 bg-brand-green rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform duration-200"
